...
@section('meta-title','Categorias | Portal ITJ Vallereal')
						...
						<div class="panel-heading">
							<div class="pull-left">
								<h6 class="txt-dark capitalize-font">
									<i class="zmdi zmdi-assignment mr-10"></i>Categorias
								</h6>
							</div>
						</div>
							...
							<div class="panel-body row">
								...
								<div class="table-wrap">
									<div class="table-responsive">
										<table class="table display responsive product-overview mb-30" id="categories">
											<thead>
												<tr>
													<th>ID</th>
													<th>Nombre</th>
  ...
  $(document).ready(function() {
    oTable = $('#categories').DataTable({
      ...
      "columns": [
        { data: 'id',name:'id' },
        { data: 'name',name:'name' },
        { data:'action',name:'name', orderable: false, searchable: false }
      ]
    });
  });
</script>
