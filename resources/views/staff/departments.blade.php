...
@section('meta-title','Departamentos | Portal ITJ Vallereal')
			...
			<div class="row heading-bg">
				...
				<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				  <ol class="breadcrumb">
						...
						<li class="active"><span>Departamentos</span></li>
				  </ol>
				</div>
				<!-- /Breadcrumb -->
			</div>
						...
						<div class="panel-heading">
							<div class="pull-left">
								<h6 class="txt-dark capitalize-font">
									<i class="zmdi zmdi-assignment mr-10"></i>Departamentos
								</h6>
							</div>
						</div>
							...
							<div class="panel-body row">
								...
								<div class="table-wrap">
									<div class="table-responsive">
										<table class="table display responsive product-overview mb-30" id="departments">
											<thead>
												<tr>
													<th>ID</th>
													<th>Nombre</th>
