				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="panel panel-success card-view">
						<div class="panel-heading">
							<div class="pull-left">
								<h6 class="panel-title txt-light">Clase de Workshop</h6>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								<p>Aqui podras inscribirte a la clase de workshop</p>
								<button class="btn btn-success btn-anim" role="link" 
												onclick="window.location='{{ route('student.workshops.index') }}'">
									<i class="icon-rocket"></i>
									<span class="btn-text">Ir a la página</span>
								</button>
							</div>
						</div>
					</div>
